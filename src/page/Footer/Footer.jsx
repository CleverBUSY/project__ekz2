...
const Footer = () => {
  return (
        <footer style={{backgroundColor: "rgba(0, 0, 0, 0.6)", borderTop: "2px solid white"}} className="text-gray-600 body-font">
  <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
    <div className="w-64 text-white flex-shrink-0 md:mx-0 mx-auto text-center md:text-left md:mt-0 mt-10">
